def run(stackargs):
    ...
    # Add substacks
    stack.add_substack('config0-publishconfig0-core::delete_schedules')
    stack.add_substack('config0-publishconfig0-core::delete_resources_by_time')
    # stack.add_substack('config0-publishconfig0-core::delete_resources')
